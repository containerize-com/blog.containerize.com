...
## Nozioni di base sullo sviluppo del plugin {#basics}
...
Per dimostrare, aggiungiamo funzionalità al nostro plug -in di test che tiene traccia della popolarità dei nostri articoli memorizzando quante volte è stato visualizzato ogni post.
