...
## Những điều cơ bản về phát triển plugin {#basics}
...
Cuối cùng, [containerize.com][8] đang viết bài về các sản phẩm nguồn mở hơn nữa. Do đó, vui lòng giữ liên lạc với các danh mục [viết blog][9] và [Phần mềm Business Intelligence][10] cho tin tức và cập nhật thông thường
