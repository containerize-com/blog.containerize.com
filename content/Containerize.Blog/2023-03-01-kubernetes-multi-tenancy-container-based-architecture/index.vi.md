...
seoTitle: "Kiến trúc nhiều người thuê & container" 
...
{{< figure align=center src="images/Kubernetes Multi-Tenancy & Container-Based Architecture.png" alt="Kiến trúc dựa trên nhiều người thuê và container Kubernetes" >}}
...
## kubernetes nhiều người thuê   {#kubernetes-multi-tenancy-}
