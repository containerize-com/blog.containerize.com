...
## Hosts de contêineres com vários inquilinos {#Multi-Tenant-container-hosts}
...
## Kubernetes Multi-Tenância {#Kubernetes-Multi-Tenancy-}
...
Em um cluster de vários inquilinos, todos os inquilinos/clientes compartilham o cluster Kubernetes, enquanto, em um cluster de inquilino único, há um cluster separado em execução para cada inquilino.
