...
## Hệ thống điều khiển phiên bản   {#phiên bản kiểm soát} là gì
...
## Cách thức hoạt động của Git   {#How}
...
## Kiểm tra kho lưu trữ Trạng thái   {#Status}
...
Bạn có thể tìm thấy các liên kết sau có liên quan:
  ...
  * **[Hiểu và tìm hiểu các chi nhánh và yêu cầu kéo trong GIT][12]**
