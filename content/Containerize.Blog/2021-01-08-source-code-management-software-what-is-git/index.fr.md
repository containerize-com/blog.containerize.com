...
## Qu'est-ce que le système de contrôle de version {#version-control}
...
## Enregistrer les modifications dans le référentiel {#commit}
...
## Vérifier l'état du référentiel {#status}
