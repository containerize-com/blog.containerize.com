...
## Sürüm kontrol sistemi nedir {#version-control}
...
### Linux'a yükleme
Basic Git araçlarını Linux'a bir ikili yükleyici aracılığıyla yüklemek istiyorsanız, bunu genellikle dağıtımınızla birlikte gelen paket yönetim aracı aracılığıyla yapabilirsiniz. Fedora (veya RHEL veya CentOS gibi yakından ilişkili RPM tabanlı herhangi bir dağılım için “DNF” kullanabilirsiniz.
```
...
$ git --version
```
Zaten yüklü değilseniz, yüklemenizi ister.

## Bir depo kurmak {#init}
...
## Değişiklikleri depoya kaydedin {#commit}
...
## Deponun durumunu kontrol edin {#status}
