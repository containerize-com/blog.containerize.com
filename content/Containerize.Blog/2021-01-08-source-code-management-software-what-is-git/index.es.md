...
{{< figure align=center src="images/version-control-banner.png" alt="Software de administración de código fuente">}}
...
## ¿Qué es el sistema de control de versiones? {#version-control}
...
Usando Git, puede hacer cambios en su repositorio local y llevarlo a una herramienta de alojamiento. O puede extraer los cambios de otros de la herramienta de alojamiento a su máquina local. Aquí hay una descripción básica de cómo funciona el software de gestión del código fuente (GIT).
  ...
  6. Realice un cambio en su archivo con una herramienta de alojamiento y confirmación de GIT
 ...
 10. "fusione" su rama a la rama maestra
...
{{< figure align=center src="images/git-status-2.gif" alt="Software de administración de código fuente">}}
