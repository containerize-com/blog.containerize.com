...
## Mengapa Anda perlu berlabuh WordPress? {#why}
...
Buat file docker-compose.yml yang memulai blog WordPress Anda dan instance mySQL terpisah dengan volume mount untuk ketekunan data:
```
version: '3.3'
