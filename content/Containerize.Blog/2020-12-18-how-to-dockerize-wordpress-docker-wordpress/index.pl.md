...
## Dlaczego musisz dokeryzować WordPress?   {#Dlaczego}
...
## Jak zainstalować Docker Compose   {#Install}
...
volumes:
    db_data: {}
```
Teraz uruchom polecenie w katalogu projektu
```
docker-compose up -d
```
...
Możesz znaleźć istotne następujące linki:
  ...
  * [Zwiększ swoje leady za pomocą bezpłatnej integracji Civicrm WordPress][2]
