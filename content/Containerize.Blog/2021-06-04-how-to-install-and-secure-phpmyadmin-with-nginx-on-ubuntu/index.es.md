...
## Paso 1: Requisitos previos {#id-prerequisites}
...
## Paso 4: Crea un enlace simbólico {#id-2-create-symbolic-link}
...
## Paso 7: Phpmyadmin seguro {#id-6-secure-phpmyadmin-recommended}
