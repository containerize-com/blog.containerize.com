...
## Passaggio 1: prerequisiti {#id-prerequisites}
...
## Passaggio 2: configurare il database {#id-1-install-phpmyadmin}
...
## Passaggio 4: crea un collegamento simbolico {#id-2-create-symbolic-link}
...
## Passaggio 7: sicuro phpmyadmin {#id-6-secure-phpmyadmin-recommended}
