...
## Etapa 1: Pré -requisitos {#id-prerequisites}
...
{{< figure align=center src="images/phpmyadmin-install2.png" alt="Como configurar o mysql com phpmyadmin">}}
...
## Etapa 4: Crie um link simbólico {#id-2-create-symbolic-link}
...
Agora você deve acessar a interface da web PhpMyadmin visitando o nome do host/domínio do servidor ou o endereço IP público, seguido por domain.com/phpmyadmin no seu navegador favorito. Por exemplo, http://example.com/phpmyadmin ou http://192.168.1.10/phpmyadmin
{{_LINE_48_}}
...
## Etapa 7: Phpmyadmin seguro {#id-6-secure-phpmyadmin-recommended}
...
```
Você deve ver algo como nome de usuário: $ APR1SDFSDF4435SDTSKLFWMMG1SFDSDGG4
