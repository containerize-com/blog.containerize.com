...
В этом руководстве мы собираемся описать шаги, как установить и защитить PhpMyAdmin с Nginx на Ubuntu 20.04. Вам нужно будет установить и настроить PhpMyAdmin на сервере Ubuntu, чтобы легко позволить ему работать с базами данных и таблицами MySQL. Итак, давайте узнаем, как установить и защитить PhpMyAdmin с Nginx на Ubuntu 20.04 / 20.10:
  ...
  * Доступ к PhpMyAdmin
  * Создать суперпользователь MySQL
  * Безопасный phpmyadmin
  * Заключение

## Шаг 1: предпосылки {#id-prerequisites}
...
{{< figure align=center src="images/mysql-setup.png" alt="Установите и защищает PhpMyAdmin для Nginx на Ubuntu 20.04">}}
...
## Шаг 6: Создайте суперпользуст MySQL {#id-4-create-mysql-superuser}
...
## Шаг 7: Безопасный PhpMyAdmin {#id-6-secure-phpmyadmin-recommended}
...
sudo nginx -t
```
Если действителен, перезагрузить Nginx config.
```
