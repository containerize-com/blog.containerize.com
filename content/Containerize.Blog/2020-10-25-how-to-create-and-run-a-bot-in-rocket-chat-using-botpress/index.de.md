...
### Codieren Sie Ihren Bot mit BotPress {#codebot}

BotPress ist ein Node.js -Paket und arbeitet mit Knoten und NPM.
Der schnellste Weg, um mit BotPress zu beginnen, ist die Verwendung von [Botpress-Kick-Starter][8] Repository, das bereits über [Botpress-Kanal-Anschluss][9] in Rocket.chat integriert ist.
