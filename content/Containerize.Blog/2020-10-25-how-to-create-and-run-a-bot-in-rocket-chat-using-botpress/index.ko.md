...
description: "이 안내서는 Botpress를 사용하여 봇을 만드는 방법과 Rocket.chat과의 통합을하는 간단하고 쉬운 단계로 가르쳐줍니다." 
...
### Rocket.Chat에서 봇 사용자를 만듭니다 {#createbotuser}
...
### botpress를 사용하여 봇을 코딩하십시오 {#codebot}
