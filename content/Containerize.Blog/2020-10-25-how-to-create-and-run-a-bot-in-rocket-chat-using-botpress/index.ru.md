...
## В этом уроке мы дадим вам, как создать бота с помощью Botpress, и это интеграция с Rocket.chat
...
Для создания учетной записи вам необходимо иметь привилегии администратора:
  ...
  7. Выберите «Бот» из раскрывающегося меню «Добавить» и нажмите кнопку _ADD ROLE_ вправо
