...
### 在Rocket.Chat中创建一个bot用户 {#createbotuser}
...
要创建帐户，您需要拥有管理特权：
  ...
  9.单击_save _
保存后，将在步骤4上使用用户名和密码配置该机器人。您可以使用“ Rocketchat \ _user”和“ Rocketchat \ _Password”环境变量，以使用此用户名和密码对登录Rocket.Chat服务器。


### 使用botpress编码机器人 {#codebot}
