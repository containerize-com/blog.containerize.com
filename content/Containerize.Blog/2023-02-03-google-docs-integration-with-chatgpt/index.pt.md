...
## Como obter a chave da API do OpenAI? {#How-to-obtain-the-OpenAI-API-key}
...
## Vamos fazer a integração do Google Docs com o ChatGPT {#Lets-do-Google-Docs-Integration-with-ChatGPT}
