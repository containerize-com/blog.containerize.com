...
## JavaScript中有什麼希望？諾言解釋了 {#What-is-promise-in-JavaScript-Promises-Explained}
...
## 為什麼我們在JavaScript中使用Promise？ {#Why-we-use-promise-in-JavaScript}
...
## 承諾如何在JavaScript中起作用？ {#How-promise-works-in-JavaScript}
...
## 如何建立諾言？ {#How-to-create-a-promise}
