...
## JavaScript中有什么希望？诺言解释了 {#What-is-promise-in-JavaScript-Promises-Explained}
...
## 为什么我们在JavaScript中使用Promise？ {#Why-we-use-promise-in-JavaScript}
...
## 承诺如何在JavaScript中起作用？ {#How-promise-works-in-JavaScript}
...
## 如何建立诺言？ {#How-to-create-a-promise}
