...
## Что такое обещание в JavaScript? Обещания объяснены {#What-is-promise-in-JavaScript-Promises-Explained}
...
## Почему мы используем обещание в JavaScript? {#Why-we-use-promise-in-JavaScript}
...
## Как работает обещание в JavaScript? {#How-promise-works-in-JavaScript}
