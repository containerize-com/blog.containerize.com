...
## O que é promessa em JavaScript? Promessas explicadas {#What-is-promise-in-JavaScript-Promises-Explained}
...
## Por que usamos promessa em javascript? {#Why-we-use-promise-in-JavaScript}
...
## Como a promessa funciona em JavaScript? {#How-promise-works-in-JavaScript}
...
## Como criar uma promessa? {#How-to-create-a-promise}
...
## Veja também
  ...
  * [Kubernetes Multi-Tenância e Arquitetura baseada em contêineres][12]
