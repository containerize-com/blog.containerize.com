---
title: "초보자 가이드는 처음부터 WordPress 테마를 만들기위한 가이드입니다" 
seoTitle: "초보자 가이드는 처음부터 WordPress 테마를 만들기위한 가이드입니다" 
...
{{< figure align=center src="images/Beginners-Guide-To-Create-WordPress-Theme-From-Scratch-1024x536.png" alt="초보자 가이드는 처음부터 WordPress 테마를 만들기위한 가이드입니다">}}
...
*  **sidebar.php -**  는 사이드 바에 대한 정보가 포함되어 있습니다.
*  **riger.php -**  바닥 글을 처리합니다.
*  **style.css -**  테마 스타일을 담당합니다.
*  **bootstrap.css -**  별도의 CSS 코드가 필요하지 않습니다. 매우 반응이 좋습니다.
*  **bootstrap.js -**  내비게이션 바 또는 탭 등에 자체 JS를 제공합니다.
