...
*  **header.php -**  มีรหัสสำหรับส่วนส่วนหัวของธีม
...
```
ในรหัสด้านบนฟังก์ชั่น WordPress ภายในจะถูกเรียกให้แสดงหมวดหมู่ที่แตกต่างกันจดหมายเหตุของโพสต์
