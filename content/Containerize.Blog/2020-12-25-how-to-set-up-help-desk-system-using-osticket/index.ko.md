...
```
  ...
  * 이제이 가상 호스트 파일을 다음 명령을 사용하여 사이트 가능 폴더에 연결하십시오.
```
...
```
  * 이제 웹 브라우저에 도메인 이름을 입력하여 다음 그림과 같이 설치 마법사를 시작하십시오.
...
{{< figure align=center src="images/How-To-Set-Up-Help-Desk-System-Using-osTicket-3.png" alt="Osticket을 사용하여 온라인 헬프 데스크 소프트웨어를 설정하는 방법">}}
  ...
  * 다음으로, 다음 명령을 실행하여 Write Access를 제거하려면 Ost-Config.php의 허가를 변경하십시오.
```
