...
## Плюсы и минусы остикета {#pros}


#### Pros
  * Osticket очень удобен для пользователей как для конечных пользователей, так и для агентов поддержки.
  * В комплекте с богатыми функциями, у Osticket есть все, что вам нужно, не слишком сложный.
...
[Как внедрить многоцелевое место в Osticket][8]
