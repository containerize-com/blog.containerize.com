...
Медицинские отделы еще более продуктивны и эффективны, чем раньше из -за замены рабочей силы на информационные системы здравоохранения. Существует ряд **онлайн -программного обеспечения для здравоохранения** , которое родило новые возможности и возможности в соответствующем секторе. В этом блоге мы рассмотрим влияние технологий и здравоохранения, освещая следующие моменты.
...
## Что такое технология здравоохранения? {#health}
...
## Каково влияние технологий здравоохранения? {#impact}
...
## Типы программного обеспечения для первичной медицинской помощи {#types}

В этом разделе статьи о технологиях и здравоохранении мы рассмотрим некоторые из следующих популярных типов программного обеспечения для здравоохранения, которые доступны. Сообщество с открытым исходным кодом разработало много программного обеспечения для здравоохранения с открытым исходным кодом, которые отвечают потребностям различных аспектов здравоохранения.
