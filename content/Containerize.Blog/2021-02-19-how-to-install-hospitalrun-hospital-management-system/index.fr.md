...
Hospitalrun est un système gratuit de gestion de l'information hospitalière open source. Cette solution de soins de santé gratuite est respectueuse de l'environnement car les utilisateurs peuvent utiliser pleinement ce logiciel gratuit même s'il n'y a pas de connectivité Internet. Il fournit de nombreuses fonctionnalités telles que la gestion des utilisateurs, les inscriptions des patients, les rendez-vous, le système de facturation, le système de sortie des patients, etc. L'interface utilisateur de ce système eHealth open source est logique où les utilisateurs peuvent facilement parcourir différents éléments. De plus, il est facile à configurer et propose une image Docker où les développeurs peuvent le déployer à l'aide d'une image Docker.
...
## Quelles sont les caractéristiques de Hospitalrun? {#features}
...
## Étapes d'installation de Hospitalrun? {#steps}
