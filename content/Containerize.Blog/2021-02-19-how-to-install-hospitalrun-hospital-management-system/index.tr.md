...
## Hospitalrun'un özellikleri nelerdir? {#features}
...
* **Uyuşturucu Yönetimi** : Bu eShalth kayıt sistemi, kullanıcıların belirli bir hastanın ilaçlarının eksiksiz verilerini kaydetmelerini sağlar.
...
CD jenerik
CD Sunucusu
Şimdi, \ `conp/initcouch.sh \ 'satırında şifreyi değiştirin ve _config-demo.js_'nin 7. satırındaki parolayı değiştirin.
