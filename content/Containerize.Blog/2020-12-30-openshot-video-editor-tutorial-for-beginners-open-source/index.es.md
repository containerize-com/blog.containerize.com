...
## Características Exploración de OpenShot {#features}
...
En el lado derecho, hay una ventana donde puedes jugar y probar los cambios. Hay muchas opciones que puede aplicar a las pistas, como la superposición, la configuración de la duración y el orden de los clips, recortes y cortes y más.
...
Si hace clic con el botón derecho en el clip en la línea de tiempo y vaya a las propiedades, un panel se abrirá en el lado izquierdo que contiene las opciones avanzadas relacionadas con los efectos de video, las animaciones y más.
