...
Prestashop 모듈**을 만들기 위해 아래 주제에 대해 자세히 설명합니다.
  * [요구 사항][1]
  * [모듈 개발의 기본 사항][2]
  * [Prestashop 모듈 만들기][3]
  * [결론][4]
...
```
* 마지막으로, 관리자 섹션을 열고**Prestashop 모듈을 설치하고 설치하십시오.
...
## 탐구하다
**Prestashop 모듈 작성 튜토리얼** 외에도 유용한 다음 링크를 찾을 수 있습니다.
