...
**IN-CONTEXT****Traduzindo** : Este é o recurso mais profissional desta plataforma de gerenciamento de localização**. Como esse recurso, você pode executar a tradução no contexto, mesmo no ambiente de produção.
**Traduções de máquinas:**  Tolgee suporta serviços de tradução de máquinas de terceiros, como [Deepl][10], [AWS Traduations][11] e [Google Transations][12].
. **Colaboração** : É outra provisão proeminente na qual diferentes partes interessadas podem trabalhar de forma colaborativa e revisão, o trabalho realizado por outros
