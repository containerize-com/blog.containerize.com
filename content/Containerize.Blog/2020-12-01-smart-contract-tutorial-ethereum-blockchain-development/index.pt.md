...
## O que é um contrato inteligente? {#what}
...
## Como construir um contrato inteligente básico? {#build}
...
Portanto, abra o [Ethereum Studio][12] IDE no navegador e você verá a seguinte interface.
...
## Como executar e implantar um contrato inteligente? {#deploy}
