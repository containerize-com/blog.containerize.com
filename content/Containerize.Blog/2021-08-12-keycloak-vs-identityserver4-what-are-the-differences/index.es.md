...
**Pila tecnológica** : En lo que respecta a las tecnologías, KeyCloak se escribe principalmente en Java con poca entrada de otros idiomas como JavaScript, HTML y algunos más. En segundo lugar, IdentityServer4 se escribe principalmente C# con la entrada de otros idiomas, como HTML y SCSS.
