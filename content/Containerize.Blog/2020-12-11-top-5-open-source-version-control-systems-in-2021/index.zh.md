...
[ **Bazaar**][14]是另一种 **版本控制工具** ，它是免费和开源的。它基于集中式存储库模型。这意味着开发人员可以在中央服务器中使用或不使用中央服务器。它支持目录跟踪。但是，此功能在Git和Mercurial等工具中不可用。 Bazaar具有出色的插件体系结构，开发人员可以设置现有的插件，以扩展功能或构建自己的插件。许多顶级项目都使用**集市** ，例如Ubuntu，MySQL，Mailman，Mariadb等。
另一方面，集市的一些很酷的特征包括：
* 支持跨平台
* 中央和分布式
* 快速有效
