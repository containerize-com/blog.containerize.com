...
##* ***Apa itu Prosedur Prasyarat dan Instalasi?****{#pre-requisites}
...
Di bagian ini, kami akan menginstal dependensi yang diperlukan dan mengatur lingkungan setempat. Sebelum pergi ke langkah berikutnya, pastikan Anda telah menginstal prasyarat berikut:
  ...
  * Docker
  * Komposisi Docker
Setelah prasyarat diinstal, jalankan perintah berikut untuk memulai utilitas QuickStart berbasis CLI.
```
...
```
[] ()
Selanjutnya, Anda dapat berinteraksi dengan blok penjelajah seperti yang ditunjukkan pada gambar di bawah ini.
