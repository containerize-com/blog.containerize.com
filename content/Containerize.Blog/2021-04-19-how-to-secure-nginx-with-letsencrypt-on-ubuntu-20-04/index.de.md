...
## Das Wichtigste zuerst: Abhängigkeiten und Voraussetzungen {#prerequisites}
...
## Schritt 1 - Installieren von Certbot {#step-1-—-installing-certbot}
...
## Schritt 2 - Bestätigung der Konfiguration von NGINX {#step-2-—-confirming-nginx-39-s-configuration}
...
## Schritt 3 - HTTPS durch die Firewall zulassen {#step-3-—-allowing-https-through-the-firewall}
...
## Schritt 4 - Erhalten Sie ein SSL -Zertifikat {#step-4-—-obtaining-an-ssl-certificate}
...
## Schritt 5-Überprüfung von Certbot Auto-Neewal {#step-5-—-verifying-certbot-auto-renewal}
