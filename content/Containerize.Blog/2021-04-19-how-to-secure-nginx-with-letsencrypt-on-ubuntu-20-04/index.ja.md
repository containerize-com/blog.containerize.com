...
## ステップ1  -  CERTBOTのインストール {#step-1-—-installing-certbot}
...
## ステップ2  -  Nginxの構成を確認します {#step-2-—-confirming-nginx-39-s-configuration}
...
## ステップ3  - ファイアウォールを介してHTTPSを許可します {#step-3-—-allowing-https-through-the-firewall}
...
## ステップ4  -  SSL証明書の取得 {#step-4-—-obtaining-an-ssl-certificate}
...
## ステップ5  -  Certbot Auto-Renewalの検証 {#step-5-—-verifying-certbot-auto-renewal}
...
_Yourは[Twitter][1]、[LinkedIn][2]、および[Facebook][3]ページに参​​加できます。コンピューターネットワークを介してコミュニケーションセキュリティを提供するためにどのような暗号化プロトコルを使用していますか？ご質問がある場合は、[ご連絡ください][4]をお願いします。
