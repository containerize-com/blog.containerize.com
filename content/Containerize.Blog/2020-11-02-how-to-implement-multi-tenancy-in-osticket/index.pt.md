...
## Visão geral da multi-literidade: {#multitenancy}
...
## Quais são os benefícios da multiestância? {#benefits}
...
## Impleção de osticket de vários inquilinos: {#implementation}
...
Confira a página seguinte para saber mais sobre o Oticket:
  ...
  * [Automatize o sistema de ticketing usando o WordPress e Osticket][8]
