...
description: "В этой статье подробно объясняется двухфакторная аутентификация (2FA), и как ее можно реализовать в .net5 с использованием IdentityServer4 и Twilio." 
...
## Как я могу реализовать аутентификацию 2FA? {#implementing2fa}
...
5. Используя пробную учетную запись, Twilio позволяет отправлять SMS только проверенным идентификаторам абонента, которыми вы можете управлять по ссылке ниже:
