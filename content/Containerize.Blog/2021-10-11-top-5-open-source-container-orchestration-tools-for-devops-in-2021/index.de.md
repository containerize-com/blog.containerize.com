...
[Docker Swarm][5] ist ein einfaches Container -Orchestrierungs -Tool, das der Docker -Plattform für die Verwaltung von Containeranwendungen nativ ist. Es ermöglicht Entwicklern, eine Gruppe von Docker -Knoten über mehrere Host -Maschinen hinweg zu erstellen, bereitzustellen und zu verwalten. Mit dem Docker Swarm -Modus können Sie Docker Engine -Cluster lokal im Docker -System verwalten. Es wird verwendet, um eine verteilte Cluster von Knoten in der Produktion effizient zu verwalten, zu skalieren und zu skalieren und zu skalieren und bereitzustellen. Einer der wichtigsten Vorteile von SWARM ist die hohe Verfügbarkeit von Serviceverfügbarkeit, die für Bewerbungen angeboten wird.
...
** Top -Unternehmen, die Docker Swarm verwenden.
...
##  **Was sind Tools für Open -Source -Containerverwaltung?**  {#4a1a}
