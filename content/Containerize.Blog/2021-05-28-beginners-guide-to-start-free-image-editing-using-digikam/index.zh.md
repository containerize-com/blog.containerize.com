---
title: "初学者指南使用Digikam启动免费图像编辑" 
seoTitle: "初学者指南使用Digikam启动免费图像编辑" 
...
{{_LINE_70_}}
{{_LINE_71_}}
    完成图像编辑和组织完成后，您可以将数字文件导出到许多地方，例如Dropbox，Google Drive，Flickr，Pinterest，Pinterest，Twitter等。只需单击导出并开始。
{{_LINE_73_}}
{{_LINE_74_}}
