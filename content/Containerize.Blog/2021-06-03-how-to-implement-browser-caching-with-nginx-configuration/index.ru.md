...
## Используйте кэширование браузера {#Browser-Caching}
...
При использовании веб-браузера значение _etag_ хранится и отправляется обратно на сервер с заголовком запроса _if-none match_, когда пользователь обновляет страницу или тот же файл, требуемый браузером по любой причине.
...
## Используйте кэширование браузера с Nginx configuration {#nginx-configuration}
