...
## Levier de mise en cache du navigateur {#browser-caching}
...
## Module d'en-tête de Nginx {#header-module}
...
## Tenuez la mise en cache du navigateur avec configuration Nginx {#nginx-configuration}
