...
## leva la cache del browser   {#cache browser}
...
Modulo di intestazione di ## nginx  {#intestazione}
...
## Levaro Caching browser con configurazione Nginx   {#nginx-configuration}
