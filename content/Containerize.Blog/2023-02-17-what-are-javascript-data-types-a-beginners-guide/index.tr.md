...
description: "JavaScript veri türleri nelerdir? JavaScript Numarası, String, Boolean, NULL, tanımsız ve daha fazlasında kullanılan 7 veri türünü öğrenmek için bu Yeni Başlayan Kılavuzu'nu izleyin." 
...
## Veri Türleri Açıklandı | Veri türü nedir? {#What-is-a-data-type}
...
```
Ek olarak, ilkel veri türleri değerle karşılaştırılır ve maliyetlendirici olmayan veri türleri her zaman referansla karşılaştırılır.
Örneğin:
```
// Primitive Data Type
