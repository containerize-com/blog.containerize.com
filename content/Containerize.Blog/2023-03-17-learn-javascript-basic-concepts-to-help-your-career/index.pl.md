...
## Co jest podnoszeniem w JavaScript   {#co-is-hoisting-in-javascript}
...
```
Zmienna „A” nie jest dostępna poza klamrami {}, ponieważ ma zakres na poziomie bloku.
**Na poziomie funkcji**: Zmienne zadeklarowane w funkcji JavaScript mają zakres lokalny.
```
function innerFunc(){
...
Postępuj zgodnie z tym JavaScript dla początkującego [Przewodnik][2], aby poznać podstawowe pojęcia JavaScript.
