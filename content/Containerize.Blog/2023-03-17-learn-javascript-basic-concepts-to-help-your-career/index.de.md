...
## Was hebt in JavaScript {#What-is-hoisting-in-JavaScript}

Das Phänomen der Funktion oder variable Deklaration neben dem aktuellen Bereich wird als Hebezeug bezeichnet. Dies ist ein sehr kritisches Konzept und die meisten JavaScript -Entwickler sind sich dessen nicht bewusst. Eine wichtige Sache, die hier jedoch zu beachten ist, ist jedoch, dass nur Funktions-/Variablendeklarationen nach oben und nicht die Funktion/variable Initialisierung vorgenommen werden.
...
## JavaScript -Schließungen {#JavaScript-Closures}
