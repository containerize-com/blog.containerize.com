...
## Instalação e configuração de jekyll {#install}
...
Para importar suas postagens de um site auto -hospedado WordPress, execute o seguinte comando em seu terminal.
```
