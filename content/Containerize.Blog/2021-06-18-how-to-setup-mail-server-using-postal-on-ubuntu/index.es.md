...
## Características de Postal {#Features}
 ...
 **Comprobación de spam y virus** : Spamassassin y Clamav se pueden integrar con el postal para escanear automáticamente los mensajes entrantes y salientes a medida que pasan a través de los servidores de correo. Esta característica también se desactiva de forma predeterminada.
