...
## เซิร์ฟเวอร์ไปรษณีย์ไปรษณีย์คืออะไร? {#Postal}
...
```
  * ถัดไปคัดลอก postal nginx config เพื่อใช้เป็นโฮสต์เสมือน
```
...
* [  **5 ซอฟต์แวร์เซิร์ฟเวอร์เมลโอเพ่นซอร์สที่ดีที่สุดสำหรับธุรกิจในปี 2020**  ][10]
