...
## Características do postal {#Features}
 ...
 **E -mails recebidos** : **O e -mail recebido** pode ser encaminhado para o HTTP Endpoint, **Servidor SMTP** e outros endereços de email usando o servidor de correio postal.
