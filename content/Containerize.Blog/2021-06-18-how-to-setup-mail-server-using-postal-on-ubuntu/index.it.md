...
## Cos'è il server postale di posta? {#Postal}
 ...
 **Pool IP** : Postal consente di inviare messaggi da una varietà di indirizzi IP. Ciò consente di assegnare più indirizzi IP a diversi server di posta o di inviare da IP diversi a seconda degli indirizzi del mittente o del destinatario.
