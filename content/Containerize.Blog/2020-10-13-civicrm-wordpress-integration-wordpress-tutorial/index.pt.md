...
## Como configurar uma estrutura de diretório? {#directory}
...
Segundo, crie uma pasta vazia chamada "Civicrm" nesse local /wp-content /uploads e forneça acesso "gravação" usando o seguinte comando.
...
## Como ativar e instalar o Civicrm no WordPress? {#install}
