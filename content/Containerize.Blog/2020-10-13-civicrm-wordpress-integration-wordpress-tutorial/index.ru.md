...
## Преимущества этой комбинации для бизнеса? {#benefits}
...
Прежде чем начать это **Учебное пособие по плагина WordPress** , мы предполагаем, что вы настроили WordPress и имеете базовое понимание для установки и активации плагинов. Кроме того, вы можете найти информацию [здесь][7] о настройке WordPress и ее функциях.
...
## Как активировать и установить CivicRM в WordPress? {#install}
...
Наконец, вкладка «Интеграция WordPress» CivicRM**будет отображаться в верхней части административной панели.
...
Вы можете найти следующие ссылки актуальными:
  ...
  * [Автоматизируйте систему продажи билетов с использованием WordPress и Osticket][25]
