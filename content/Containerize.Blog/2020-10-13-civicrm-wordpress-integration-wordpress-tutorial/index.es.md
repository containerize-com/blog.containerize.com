...
## Beneficios de esta combinación para negocios? {#beneficios}
...
## ¿Cómo configurar una estructura de directorio? {#directorio}
...
En segundo lugar, cree una carpeta vacía llamada "CivicRM" en esta ubicación /WP-Content /Supars y brinde acceso a "Escribir" usando el siguiente comando.
...
## ¿Cómo activar e instalar CivicRM en WordPress? {#instalar}
