...
## **Visão geral** :
Você precisa instalar e configurar **nginx com o passageiro no servidor AWS Production** antes de implantar seu aplicativo no servidor de produção.
...
## 1. O que é nginx e passageiro? {#step-4:-update-regularly}
...
## 2. Instale os pacotes Nginx e de passageiros: {#step-1:-install-passenger-packages}
...
## 3. Ative o módulo Nginx do passageiro e reinicie o nginx: {#step-2:-enable-the-passenger-nginx-module-and-restart-nginx}
...
## 4. Validar instalações: {#step-3:-check-installation}
...
## 5. Atualizações do sistema e de passageiros: {#step-4:-update-regularly}
...
## 6. **Os melhores servidores da web de código aberto** : {#step-4:-update-regularly}
