...
description: "Posting blog ini menjelaskan langkah -langkah untuk pemasangan NginX dengan penumpang melalui sistem operasi Ubuntu 20.04 LTS mengikuti metode APT." 
...
{{< figure align=center src="images/Nginx-With-Passenger-on-AWS-Production-Server.png" alt="Pengaturan Nginx dengan penumpang di server produksi AWS">}}
...
## 1. Apa itu Nginx dan Penumpang? {#step-4:-update-regularly}
...
## 2. Instal Paket Nginx dan Penumpang: {#step-1:-install-passenger-packages}
...
## 3. Aktifkan modul Nginx penumpang dan restart nginx: {#step-2:-enable-the-passenger-nginx-module-and-restart-nginx}
...
## 4. Validasi Instalasi: {#step-3:-check-installation}
...
## 5. Pembaruan Sistem dan Penumpang: {#step-4:-update-regularly}
...
## 6. **Server web open source terbaik** : {#step-4:-update-regularly}
