...
{{< figure align=center src="images/Nginx-With-Passenger-on-AWS-Production-Server.png" alt="Ustaw nginx z pasażerem na serwerze produkcyjnym AWS">}}


## **Przegląd**:
Musisz zainstalować i skonfigurować **nginx z pasażerem na serwerze AWS Production**  przed wdrożeniem aplikacji na serwerze produkcyjnym.
...
## 1. Co to jest Nginx i pasażer?   {#krok-4: -Update-regularnie}
...
## 2. Zainstaluj pakiety Nginx i pasażer:   {#krok 1: -install-Pasher-Packages}
...
## 4. Walidź instalacje:   {#krok-3: -Check-instalacja}
...
## 5. Aktualizacje systemu i pasażerów:   {#krok-4: -Update-regularly}
...
## 6. **Najlepsze serwery sieciowe open source** :   {#krok-4: -Update-regularly}
