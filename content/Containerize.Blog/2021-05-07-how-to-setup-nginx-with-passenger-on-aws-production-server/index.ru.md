...
## **Обзор** :
Вам необходимо установить и настроить **nginx с пассажиром на сервере AWS** , прежде чем развернуть приложение на производственном сервере.
...
В этой статье в блоге мы рассмотрим некоторые из основных этапов конфигурации для установки сервера веб -приложений в операционную систему Ubunt Вы сможете развернуть и управлять веб -приложениями, написанными в Node.js, Python и Ruby после прочтения и следующего ниже руководства.
...
## 1. Что такое nginx и пассажир?   {#Шаг-4: -Update-Регулярно}
...
## 3. Включите модуль пассажира nginx и перезапустить Nginx:   {#шаг 2: -Enable-the-passenger-nginx-module-and-restart-nginx}
...
## 4. Подтвердите установки:   {#Шаг-3: -чек-Инсталляция}
...
## 5. Обновления системы и пассажиров:   {#Шаг 4: -Update-Регулярно}
...
## 6. **Лучшие веб-серверы с открытым исходным кодом** :   {#Шаг-4: -Update-Регулярно}
