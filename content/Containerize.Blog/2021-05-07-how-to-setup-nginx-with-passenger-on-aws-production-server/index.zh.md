...
{{< figure align=center src="images/Nginx-With-Passenger-on-AWS-Production-Server.png" alt="带有AWS生产服务器上的乘客的设置NGINX">}}
...
在此博客文章中，我们将介绍在** APT方法**的Ubuntu操作系统上安装Web应用程序服务器的一些基本配置步骤。在阅读和以下指南以下指南后，您将能够部署和管理用Node.js，Python和Ruby编写的Web应用程序。
  ***什么是nginx和乘客？**
  ***安装nginx和乘客软件包**
...
**什么是开源Web服务器？**开源Web服务器软件是一种公共域软件，旨在通过Internet Worldwood Web提供网页。基本上，它通过HTTP网络协议处理请求，以在万维网上分发信息。
