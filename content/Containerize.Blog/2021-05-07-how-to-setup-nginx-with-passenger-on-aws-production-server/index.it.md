...
## 1. Che cos'è Nginx e passeggero? {#step-4:-update-regularly}
...
## 2. Installare i pacchetti NGINX e passeggeri: {#step-1:-install-passenger-packages}
...
## 3. Abilita il modulo NGINX del passeggero e riavvia NGINX: {#step-2:-enable-the-passenger-nginx-module-and-restart-nginx}
...
## 4. Convalida installazioni: {#step-3:-check-installation}
...
## 5. Aggiornamenti di sistema e passeggeri: {#step-4:-update-regularly}
...
## 6. **I migliori server Web open source** : {#step-4:-update-regularly}
