...
## 4.驗證安裝： {#step-3:-check-installation}
...
**什麼是開源網絡服務器？基本上，它通過HTTP網絡協議處理請求，以在萬維網上分發信息。
...
恭喜，您已經成功安裝和配置了Nginx，並在 **AWS Production Server上為Web應用程序提供了乘客。請查看[乘客庫][5]中的各種指南，以完全掌握乘客應用程序服務器。您可能對通過** Capistrano**的Ruby應用程序的[自動部署][6]指南特別感興趣，該指南會教您如何在沒有太多手動工作的情況下自動部署未來的應用程序更新。現在，您準備在AWS生產實例上部署Web應用程序。
