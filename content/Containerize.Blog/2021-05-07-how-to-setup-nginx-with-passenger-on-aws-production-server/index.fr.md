...
## 1. Qu'est-ce que Nginx et le passager? {#step-4:-update-regularly}
...
## 2. Installez les packages Nginx et Passenger: {#step-1:-install-passenger-packages}
...
## 3. Activez le module Passenger Nginx et redémarrez Nginx: {#step-2:-enable-the-passenger-nginx-module-and-restart-nginx}
...
## 4. Valider les installations: {#step-3:-check-installation}
...
## 5. Mises à jour du système et des passagers: {#step-4:-update-regularly}
...
## 6. **Les meilleurs serveurs Web open source** : {#step-4:-update-regularly}
