...
## Что означает NFT и как это работает? {#mean}
 ...
 **Представление** : NFT всегда представляет собой объект реальной жизни, который может быть чем угодно, например, картина, видео, аватар игры и т. Д., В то время как криптовалюта-это зашифрованная форма цифровой валюты, которая имеет ценность в цифровой форме.
