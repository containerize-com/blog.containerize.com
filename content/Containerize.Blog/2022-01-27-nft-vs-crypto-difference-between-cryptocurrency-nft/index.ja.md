...
## NFTとはどういう意味ですか、どのように機能しますか？ {#mean}
...
とりわけ、誰でも、所有者に関する完全な情報を表示できるようにするブロックチェーン上のNFTを確認できます。[スマートコントラクト][9]は、ブロックチェーンネットワーク上の不可能なトークンのトランザクションを管理するために使用されます。また、この[ブログ投稿][2]で、いくつかの人気のあるNFTマーケットプレイスについて、確認することができます。
