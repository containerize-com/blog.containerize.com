...
## 人工知能（AI）とは何ですか？ {#What-is-Artificial-Intelligence}
...
## 人工知能の種類 {#Types-of-Artificial-Intelligence}
...
#### 強力な人工知能
強力な人工知能は、人間の脳の正確なシミュレーションを提供します。人工的な一般情報と人工的な密集物もこのカテゴリに属します。このカテゴリは、人間の介入なしに物事を処理し、意思決定を行う能力を含むシステムとモデルを設計します。インタラクティブロボットは、強力なAIの例であり、自動運転車には、巨大なデータセットでトレーニングされ、ニューラルネットワークを使用して決定を下すことができるシステムが豊富に含まれています。さらに、このようなシステムは、過去の経験に基づいて予測を行うことができます。

## **人工知能の用途** {#Applications-of-Artificial-Intelligence}
