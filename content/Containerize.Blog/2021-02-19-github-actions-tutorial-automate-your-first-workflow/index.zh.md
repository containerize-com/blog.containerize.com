...
首先，让我们熟悉 **github动作** 的语法和术语。
  ***工作流：**由于GitHub操作提供了构建端到端**连续集成和连续部署的设施**功能，因此该术语是指何时通过CI工具开始执行流程。
...
从github上的存储库中，在**。github/workflows **目录中创建一个新文件，名为 **superlinter.yml ** ，然后将以下内容复制到其中
```
name: Super-Linter
