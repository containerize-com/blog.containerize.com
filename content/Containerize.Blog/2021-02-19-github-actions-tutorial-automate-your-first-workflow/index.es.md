...
**Implementación continua** es un paso por delante en sus flujos de trabajo CI/CD. No solo construye y prueba su aplicación cada vez que un cambio de código se presiona a la base de código, sino que la aplicación también se implementa continuamente en su servidor.

## ¿Qué son las acciones de Github? {#github-actions}
...
* **Flujo de trabajo:**  Dado que la acción GitHub proporciona la facilidad para construir una integración continua e implementación continua**Capacidades, este término se refiere a ese punto cuando el flujo comienza a ejecutar la herramienta CI.
