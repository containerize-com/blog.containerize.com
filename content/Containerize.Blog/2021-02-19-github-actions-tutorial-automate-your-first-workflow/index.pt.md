 ...
 **A implantação contínua **  está um passo à frente nos seus fluxos de trabalho de CI/CD. Ele não apenas criou e testa seu aplicativo sempre que uma alteração de código é empurrada para a base de código, mas o aplicativo também é implantado continuamente no seu servidor.

## O que são ações do github   {#githubation-ação}
