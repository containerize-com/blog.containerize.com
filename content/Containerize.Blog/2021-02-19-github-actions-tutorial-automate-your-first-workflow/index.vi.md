...
## Hành động GitHub là gì {#github-actions}
...
* **Bước:**  Để một công việc hoàn thành việc thực thi, nó phải hoàn thành tất cả các bước được nhúng trong đó.
...
## Tạo một quy trình làm việc {#workflow}
