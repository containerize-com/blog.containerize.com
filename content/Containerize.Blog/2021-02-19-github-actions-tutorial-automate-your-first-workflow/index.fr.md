...
description: "Suivez ce didacticiel GitHub Actions pour explorer que comment pouvons-nous utiliser des actions GitHub pour automatiser et exécuter nos flux de travail de développement de logiciels à partir de notre dépôt." 
...
## GitHub a introduit des actions GitHub qui vous permettent de configurer l'intégration continue et le déploiement continu à l'aide d'un fichier de configuration directement dans votre dépôt GitHub.
...
**Déploiement continu** est une longueur d'avance dans vos workflows CI / CD. Il a non seulement construit et teste votre application à chaque fois qu'une modification de code est poussée vers la base de code, mais l'application est également déployée en continu sur votre serveur.
