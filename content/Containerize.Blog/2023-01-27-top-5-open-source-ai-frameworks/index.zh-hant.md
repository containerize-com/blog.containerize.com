...
[Scikit-Learn][22]是用Python編寫的  **開源AI框架** 中的另一個。它提供了預測性數據分析，並且具有高度可擴展性。這個機器學習框架一直是[J.P. -Morgan][23]，[Spotify][24]，[Booking.com][25]等許多大公司的 **AI系統**  的組成部分。 Booking.com使用Sckikit-Learn向客戶推薦酒店和旅行目的地。
