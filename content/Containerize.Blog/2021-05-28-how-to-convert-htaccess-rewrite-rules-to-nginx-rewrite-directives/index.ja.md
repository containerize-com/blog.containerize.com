---
title: "htaccessを変換する方法ルールをnginxの書き換え指令に書き換える" 
seoTitle: "htaccessを変換する方法ルールをnginxの書き換え指令に書き換える" 
...
```
しかし、URL間の複雑な区別を実行したり、元のURLで要素をキャプチャしたり、パスに要素を変更または追加する必要がある場合はどうでしょうか？そのような場合には、_rewrite_ディレクティブを使用できます。
...
## .htaccessの書き換えルールの書き換え指令を書き換えます {#convert}
