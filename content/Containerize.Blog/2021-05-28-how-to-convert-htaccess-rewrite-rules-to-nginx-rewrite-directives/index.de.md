...
*  **[Nginx Regeln neu schreiben][2]**  
* [**.
* [  **konvertieren .htaccess -Regeln in Nginx -Schreibanweisungen**  ][4]
* [  **Fazit**  ][5]

## Nginx schreibt Regeln neu {#nginx}
...
```
Aber was ist, wenn Sie komplizierte Unterschiede zwischen URLs durchführen, Elemente in der ursprünglichen URL erfassen oder Elemente auf dem Pfad ändern oder hinzufügen müssen? Sie können die _rewrite_ -Anweisung in solchen Fällen verwenden.
...
## Konvertieren Sie .htaccess -Regeln in Nginx -Umschreiben von Richtlinien {#convert}
