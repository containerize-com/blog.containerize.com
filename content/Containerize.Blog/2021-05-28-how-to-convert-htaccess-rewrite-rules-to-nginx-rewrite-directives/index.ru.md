...
Например, следующее .htaccess Правило переписывает правило Redricts URL без www в URL www.
```
RewriteEngine On
...
## преобразовать .htaccess Правила переписывания в директивы nginx rewrite {#convert}
