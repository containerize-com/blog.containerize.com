...
## Обзор
Недавно мы опубликовали сообщение в блоге на [5 Top Systeck Sognal Sight-программное обеспечение с открытым исходным кодом в 2021 году][1], которое дает краткое введение в Top  **SSO System**  . В этом сообщении мы рассмотрим следующие моменты.
* [  **Что такое технология SSO?**  ][2]
*  **[HO][3]** [  **W**][3]** [Single Sign-On (SSO) работает?][3]** 
* [  **Ссуды по использованию бизнеса SSO System**  ][4]
* [  **Заключение**  ][5]

## Что такое технология SSO? {#what}
...
##  **Как работает отдельный вход (SSO)?**  {#features}
...
## Взяты в сфере использования бизнеса SSO System {#business}
