...
Während der Entwicklungsphase ist die Platzierung von Designelementen sehr kritisch für die Erlangung:
  ...
  * Lesbarkeit
Hier kommt die **Joomla -Vorlagen** . Diese Open -Source -Software bietet vor, vordefinierte Reaktionslayouts für alle Webseiten zu entwickeln oder zu verwenden, anstatt für jede Seite Code separat zu schreiben.
...
## Wie erstelle ich eine einfache reaktionsschnelle Vorlage in Joomla? {#how}
...
Geben Sie diesen Code in die Datei **templatEdetails.xml** ein.
```
...
## Wie installiere ich Joomla -Vorlage? {#install}
...
Da die Kategorie von **CMS -Software** konsistente Verbesserungen steht und mehr Tutorials zu anderen Content -Management -Systemen zur Liste hinzugefügt werden, bleiben Sie mit dem Abschnitt [Content Management System][6] für regelmäßige Aktualisierungen in Kontakt.
