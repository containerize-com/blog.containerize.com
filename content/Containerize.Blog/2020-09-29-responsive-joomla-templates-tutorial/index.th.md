...
ในระหว่างขั้นตอนการพัฒนาการจัดวางองค์ประกอบการออกแบบมีความสำคัญอย่างยิ่งที่จะได้รับ:
  ...
  * เข้ากันได้กับมือถือ
  * ความสามารถในการอ่าน
ที่นี่เทมเพลต Joomla**มาที่นี่ ซอฟต์แวร์โอเพ่นซอร์สนี้ให้ข้อกำหนดในการพัฒนาหรือใช้เลย์เอาต์ตอบสนองที่กำหนดไว้ล่วงหน้าสำหรับหน้าเว็บทั้งหมดแทนที่จะเขียนโค้ดสำหรับแต่ละหน้าแยกกัน
...
**เทมเพลตส่วนหน้า:**  เกี่ยวข้องกับผู้ใช้ที่ต้องเผชิญกับส่วนหนึ่งของเว็บไซต์ธุรกิจ
**เทมเพลตแบ็คเอนด์:**  เทมเพลตเหล่านี้เชื่อมโยงกับตรรกะทางธุรกิจของเว็บไซต์

## จะสร้างเทมเพลตที่ตอบสนองได้ง่าย ๆ ใน Joomla? {#how}
...
```
บรรทัดแรกหลังจากแท็กบอก Joomla ให้ใส่ข้อมูลส่วนหัวเช่นข้อมูลข้อมูลเมตาและชื่อหน้า
...
## จะติดตั้งเทมเพลต Joomla ได้อย่างไร? {#install}
