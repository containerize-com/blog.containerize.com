...
## 3. Набор и вскрытие - анализ диска - дисковый анализ {#ce62}
...
## 4. Структура волатильности - криминалистика памяти {#ce62}
...
## 5. Без исследовательского криминалистического инструментария (SIFT) - SIFT Workstation для Ubuntu {#b49b}
