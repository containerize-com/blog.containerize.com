...
## **고객 지원을위한 헬프 데스크 티켓팅 시스템** {#helpdesk}
...
## **인스턴트 지원을위한 라이브 채팅 소프트웨어** {#live-Chat}
...
## **양식 빌더를 사용하여 비즈니스 양식을 작성하십시오** {#forms-builder}
...
## **트랜잭션 또는 대량 이메일 전송 플랫폼** {#Transactional-Email}
...
## **서버 상태 모니터 일명 상태 페이지 소프트웨어** {#상태 페이지}
...
## **회계 소프트웨어 일명 인보이스 소프트웨어** {#InVoInce}
제품이나 서비스를 판매하는 경우 비즈니스에 인보이스 소프트웨어를 갖는 데 관심이 있습니다. 따라서 Containerize.com은 오픈 소스 인보이스 소프트웨어에 대한 세부 정보를 제공합니다.
  ...
  * [Carter][79]-소기업이 송장을 생성 할 수있는 자체 호스팅 인보이스 시스템.
