...
description: "Führen Sie Ihr papierloses Geschäft mit einer Reihe von Open -Source -Software mit geringerem Aufwand, vollständiger Anpassung und hoher Produktivität von überall aus fern." 
...
##  **Diskussionsforum für das Aufbau von Gemeinschaft**  {#forums}
...
##  **Erstellen Sie Geschäftsformulare mit dem Formular Builder**  {#forms-builder}
...
##  **Transaktions- oder Bulk -E -Mails zu Lieferplattformen**  {#transactional-email}
...
##  **Serverstatus -Monitor alias Statuspage -Software**  {#status-page}
