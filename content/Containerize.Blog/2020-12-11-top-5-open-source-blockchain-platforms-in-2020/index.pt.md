...
summary: "A tecnologia Blockchain é baseada em um livro distribuído protegido com criptografia. É imutável por natureza e fornece maior segurança e disponibilidade." 
url: /pt/top-5-open-source-blockchain-platforms-in-2020/
categories: ['Blockchain Platforms']
---

A tecnologia Blockchain é baseada em um livro distribuído protegido com criptografia. É imutável por natureza e fornece maior segurança e disponibilidade.

{{< figure align=center src="images/block-1.png" alt="Plataformas blockchain de código aberto">}}
...
O Hyperledger Fabric possui os seguintes recursos importantes:
  ...
  * Suporte ao contrato inteligente de várias linguagens
  * Dados consultáveis
[Leia mais] [14]
...
OpenChain oferece os seguintes recursos importantes:
  ...
  * Validação no nível instantâneo
...
## Multicain
[Multicain] [18] é outro software de código aberto que oferece um rápido desenvolvimento de aplicativos blockchain públicos e privados. Em primeiro lugar, é altamente personalizável, amigável e flexível. Em segundo lugar, fornece a maior segurança por meio de chaves públicas e assinaturas multi. Em terceiro lugar, este software de código aberto fornece etapas fáceis para desenvolver e implantar aplicativos blockchain. Além disso, está escrito na linguagem C ++ e seu código -fonte está disponível no [Github] [19].
Multicain cria os seguintes recursos principais:
  * Suporte para ativos ilimitados
  * Gerenciamento de permissões
  * Seguro com a chave público-privada
  * Flexível e robusto
