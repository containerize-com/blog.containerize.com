...
* **星數:**  159,000
* **叉數:**  85,500
[TensorFlow][4]是一個流行的開源 **機器學習框架** 用於人工智能和計算機視覺應用程序，該應用程序是由Google Brain Team**在2015年根據Apache 2.0開放源代碼許可而創建的。 Tensorflow Python庫用於帶有數據流程圖的快速數值計算。它使開發人員可以專注於深度神經網絡的培訓和推斷。
...
* **星數:**  81,300
* **叉數:**  2,960
[Kubernetes][6]是一個開源容器編排平台，也稱為 **k8s或kube**。 Kubernetes在容器空間中的OG是開源系統，用於實時自動化集裝箱的計算機應用程序構建，部署，測試，擴展資源和應用程序。 **k9s** kubernetes，**kubernetes cli** ，它使kubernetes簇變得更加容易。
