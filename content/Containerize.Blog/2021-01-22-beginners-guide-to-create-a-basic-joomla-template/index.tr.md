...
*  **[Temel TemplateTails.xml Dosyası Oluştur][3]**  
...
## Temel Templatedetails.xml Dosyası Oluşturun {#xml}
...
## Basic Index.php dosyası oluşturun {#php}
...
## Şablonu keşfedin ve yükle {#install}
...
Şablonunuz bir dizin myTemplate/ daha sonra paketi yapmak için bu dizine bağlanabilir ve şu komutları kullanabilirsiniz:
```
