...
Ага! Готово. Теперь вы знаете, как полностью установить программное обеспечение для обмена файлами с открытым исходным исходным кодом на Ubuntu для создания частного облака шаг за шагом, аналогично Dropbox или Google Drive.

##  **Заключение:**   {#4a1a}

В этом уроке вы успешно установили ячейки Pydio с открытым исходным исходным кодом в системе Ubuntu. Вы можете использовать эту статью для создания облачной инфраструктуры для хранения, обеспечения и обмена вашими файлами в облаке самостоятельно. Используйте совместное обмен документами Pydio и лучшее бесплатное приложение для совместного использования файлов, чтобы получить больше контроля над вашими данными и обеспечить эффективное сотрудничество в вашей бизнес -организации. В наших будущих учебных пособиях мы обсудим более интересные темы решений облачного хранения с открытым исходным кодом и инструментов совместной работы по обмену файлами.
