...
## Cos'è CivicRM?   {#civi}
Questo [software di gestione delle relazioni costituenti][4] è open source, gratuito e viene fornito con capacità di auto-osting. CivicRM è altamente estensibile e offre integrazione con il software di gestione dei contenuti più utilizzati, software di blog come [WordPress][11], [Joomla][12], [Drupal][13] e altro ancora. Questo  **software di automazione gratuita**  è ricco di caratteristiche e viene fornito con strumenti di reporting per generare vari report. Inoltre, ti consente di impostare campagne di difesa, raccolta fondi peer-to-peer, gestione degli eventi e gestione dei casi.
