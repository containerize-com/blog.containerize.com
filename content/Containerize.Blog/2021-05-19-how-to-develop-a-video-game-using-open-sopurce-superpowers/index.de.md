...
*  **[Wie richten Sie auf Localhost ein?][3]**  
*  **[Dashboard der Supermächte?][4]**  
*  **[Schlussfolgerung][5]**  

## Was ist Superkräfte? {#intro}
...
## Wie richten Sie auf Localhost ein? {#setup}
...
Stellen Sie zunächst sicher, dass Sie die folgenden Voraussetzungen installiert haben, bevor Sie mit der Entwicklung der Videospiele beginnen:
  * Git
  * npm
  * Node.js
...
## Dashboard von Supermächten? {#features}
...
* [  **Top 5 Free Game Development Software im Jahr 2021**  ][23]
