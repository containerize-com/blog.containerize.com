...
## O que são superpotências {#intro}
...
## Como configurar o localhost? {#setup}
...
## Painel de superpotências? {#features}
...
*  **[Tutorial do GDevelop para iniciantes iniciarem o desenvolvimento do jogo][22]**  
