...
## Async/chờ đợi trong JavaScript | Async đang chờ cú pháp {#What-is-AsyncAwait-in-JavaScript-Async-Await-Syntax}
...
## Khi nào nên sử dụng async/đang chờ? {#When-to-use-AsyncAwait}
...
## Xử lý lỗi với Async/đang chờ đợi {#Error-handling-with-AsyncAwait}
