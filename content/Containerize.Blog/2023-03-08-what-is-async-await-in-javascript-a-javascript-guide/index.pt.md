...
## O que é assíncrono/aguardar em javascript | ASYNC Aguardar sintaxe {#What-is-AsyncAwait-in-JavaScript-Async-Await-Syntax}
...
## Quando usar async/aguardar? {#When-to-use-AsyncAwait}
...
## Manipulação de erros com assíncrona/aguardar {#Error-handling-with-AsyncAwait}
