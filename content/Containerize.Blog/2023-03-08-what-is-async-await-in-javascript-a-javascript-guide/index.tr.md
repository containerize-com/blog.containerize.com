...
Bu JavaScript Async Bekleyen Eğitimde aşağıdaki bölümlerden geçeceğiz:
...
## JavaScript'te Async/Weait Nedir | Async Sözdizimi Bekliyor {#What-is-AsyncAwait-in-JavaScript-Async-Await-Syntax}
...
## Ne zaman eşzamanlı/beklemeli? {#When-to-use-AsyncAwait}
...
## Async/Await ile hata işleme {#Error-handling-with-AsyncAwait}
...
Async beklemeyi anlamak için bunu [link][3] ziyaret edebilirsiniz.
...
## Ayrıca bakınız
  * [JavaScript'te söz nedir? | JavaScript eğitimi][1]
