...
## ما هو async/في انتظار JavaScript | Async ينتظر بناء الجملة   {#what-is-asyncawait-in-javascript-async-await-syntax}
...
## متى تستخدم Async/في انتظار؟   {#موعد الاستخدام asyncawait}
...
## معالجة الأخطاء مع async/ench   {#معالجة الأخطاء with-asyncawait}
