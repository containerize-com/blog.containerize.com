...
## Apa itu Async/Await di JavaScript | Async menunggu sintaks {#What-is-AsyncAwait-in-JavaScript-Async-Await-Syntax}
...
## Kapan Menggunakan Async/Await? {#When-to-use-AsyncAwait}
...
## Penanganan kesalahan dengan async/menunggu {#Error-handling-with-AsyncAwait}
