...
## Co to jest asynchronizacja/oczekiwanie w JavaScript | Async oczekuje na składnię {#What-is-AsyncAwait-in-JavaScript-Async-Await-Syntax}
...
## Kiedy korzystać z asynchronizacji/oczekiwać? {#When-to-use-AsyncAwait}
...
## Obsługa błędów za pomocą asynchronizacji/oczekiwania {#Error-handling-with-AsyncAwait}
