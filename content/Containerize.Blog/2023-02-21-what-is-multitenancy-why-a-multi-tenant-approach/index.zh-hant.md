...
## 什麼是多重？多租戶與單租戶 {#What-is-Multitenancy-Multi-Tenant-vs-Single-Tenant}
...
## 多租戶應用程序體系結構的類型 {#Types-of-Multi-Tenant-Application-Architecture}
...
## 多租戶應用程序的業務利益 {#Business-Benefits-of-Multi-Tenant-App}
...
## 多租戶的缺點 {#Drawbacks-in-Multi-Tenancy}
