...
## Qu'est-ce que le multittenance? Multi-locataire vs unique {#What-is-Multitenancy-Multi-Tenant-vs-Single-Tenant}
...
## Types d'architecture d'applications multi-locataires {#Types-of-Multi-Tenant-Application-Architecture}
...
## Inconvénients de plusieurs tenues {#Drawbacks-in-Multi-Tenancy}
