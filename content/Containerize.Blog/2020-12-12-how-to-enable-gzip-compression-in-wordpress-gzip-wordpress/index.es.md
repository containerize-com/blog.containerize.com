...
{{< figure align=center src="images/Asset-1.png" alt="Habilitar compresión de GZIP">}}
...
## ¿Qué es la compresión de GZIP? {#what}
...
## ¿Cómo funciona la compresión de GZIP? {#work}
...
## Habilitar la compresión de GZIP en WordPress {#enable}
