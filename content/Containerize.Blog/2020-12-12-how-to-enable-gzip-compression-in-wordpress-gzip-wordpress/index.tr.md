...
## GZIP sıkıştırma nasıl çalışır? {#work}
...
## **GZIP Sıkıştırma Etkin olup olmadığını nasıl doğrulayabilirim?** {#verify}
...
Sitenizi bir krom tarayıcıda açın, ardından sayfanın herhangi bir yerine sağ tıklayın ve* *****İnceleyin**Geliştirici Araçlarını** açmak için**açın.
...
## WordPress'te GZIP sıkıştırmasını etkinleştirin {#enable}
