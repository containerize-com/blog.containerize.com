...
summary: "페이지 속도와로드 시간은 검색 엔진에서 더 나은 순위를 높이기위한 주요 요소입니다. GZIP 압축은이를 가능하게하고 경쟁 우위를 제공 할 수 있습니다." 
...
파일 및 폴더 압축을 활성화하려면 웹 서버에서 GZIP 압축을 활성화해야합니다. 곧 웹 서버에 GZIP가 활성화되어 있는지 확인하는 방법을 확인할 것입니다.

## GZIP 압축은 어떻게 작동합니까? {#work}
...
## WordPress에서 GZIP 압축을 활성화하십시오 {#enable}
