...
## 什麼是無服務器計算？ {#What-is-serverless-computing}
...
**無服務器體系結構**和容器化為開發人員提供了一些類似的規定。這兩個環境都減去了應用程序部署的麻煩。此外，這些生態系統被認為比虛擬機（VM）更好。此外，資源縮放是根據無服務器中的使用來進行的，而您必須手動在容器中縮放服務器資源。
...
## 無服務器計算的業務利益 {#Business-benefits-of-Serverless-Computing}
