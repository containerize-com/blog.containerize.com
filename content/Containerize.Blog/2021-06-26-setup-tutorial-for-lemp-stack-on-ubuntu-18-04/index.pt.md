...
```
  * Vamos dar uma breve olhada nessas diretrizes e no bloco de localização, para que você possa ter informações básicas.
...
* [  **Licenses de código aberto mais populares mais populares de 2021**  ][13]
