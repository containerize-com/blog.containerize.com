...
phpinfo();
```
  * Откройте свой веб -браузер и введите имя доменного домена или общедоступный IP -адрес Server, а затем имя PHP, например http: // server \ _ip \ _or_domain/info.php. Вы увидите на странице ниже.
...
Вы можете найти следующие ссылки актуальными:
  ...
  ***[Лучшее программное обеспечение для обмена хранением и обменом файлами с открытым исходным кодом][10]** 
