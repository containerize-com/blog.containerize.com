...
* **Benachrichtigungen** -Stating unterstützt die meisten wichtigen Anträge von Drittanbietern für den Empfang von Benachrichtigungen.
...
## Installieren unter Linux {#Installing}
...
## Konfigurieren Sie den Systemd -Dienst {#Configure}
...
## Service zur Überwachung erstellen {#Create}
