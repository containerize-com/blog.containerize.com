...
## Что такое объектная модель документа (DOM)? {#What-is-Document-Object-Model}
...
## Что такое Dom Properties и как получить к ним доступ? {#What-are-DOM-properties-and-how-to-access-them}
