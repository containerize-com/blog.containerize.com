...
## Document Object Model (DOM) คืออะไร? {#What-is-Document-Object-Model}
...
## คุณสมบัติของ DOM คืออะไรและจะเข้าถึงได้อย่างไร? {#What-are-DOM-properties-and-how-to-access-them}
