...
{{_LINE_46_}}
{{_LINE_47_}}
Créons le sous-répertoire **Node_Modules** dans / home / nœud avec le répertoire de l'APP. Cela garantira qu'ils ont les autorisations nécessaires, qui seront importantes lorsque nous créerons des modules de nœuds locaux dans le conteneur avec l'installation de NPM.
```
...
...
## Construire l'image et exécuter un conteneur {#build}
