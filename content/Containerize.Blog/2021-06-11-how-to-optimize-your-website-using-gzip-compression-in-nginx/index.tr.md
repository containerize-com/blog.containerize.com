...
## GZIP sıkıştırma nasıl çalışır? {#how-gzip}
...
## Nginx'te GZIP sıkıştırmasını etkinleştirin {#enable-gzip}
...
. . .
```
Gördüğünüz gibi GZIP varsayılan olarak _gzip açık; _, ancak başka yorumlanan GZIP ayarları vardır.
...
## GZIP sıkıştırmasını doğrulayın {#verify}
