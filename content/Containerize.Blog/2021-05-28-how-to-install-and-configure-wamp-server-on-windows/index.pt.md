...
* Localize o arquivo  **WAMP download**  e clique duas vezes nele para executar o processo de instalação.
  ...
  * Escolha o eu aceito a caixa de seleção do Contrato e clique no botão Avançar.
...
## Configuração do WAMP {#Configuration}
