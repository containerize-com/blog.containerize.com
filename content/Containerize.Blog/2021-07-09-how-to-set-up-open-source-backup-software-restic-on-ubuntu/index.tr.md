...
Restic Backup yazılım programı üç ana işletim sistemi Linux, macOS ve Windows'u destekler. **Restic Backup** yüklemeden önce aşağıdaki sistem gereksinimlerini karşılamalısınız.
  ...
  * İki istemci ve sunucu arasında yapılandırılan SSH anahtar kimlik doğrulaması
...
Restic Self Barındırılan Bulut Yedekleme, yedek depolama için arka uçları takip eden kutudan çıkmayı destekler.
  * Yerel dizin
...
### Docker kullanarak yükleme
  * RITIC görüntüsünü Dockerhub'dan alın.
```
