import { AppApiBase, JobFileResult, FileLink, JOB_RESULT_PENDING, JOB_RESULT_RUNNING, JOB_RESULT_COMPLETED } from "../../html/api/AppApiBase";
import { ConverterApi } from "../../html/api/ConverterApi";
import { MergerApi } from "../../html/api/MergerApi";



export class SVGAppApi extends AppApiBase implements ConverterApi, MergerApi {
